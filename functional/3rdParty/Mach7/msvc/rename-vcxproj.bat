...
rename %~p1%filename%.vcxproj         %filename%.2010.vcxproj
rename %~p1%filename%.vcxproj.filters %filename%.2010.vcxproj.filters
rename %~p1%filename%.vcxproj.user    %filename%.2010.vcxproj.user
goto END
